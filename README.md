...
public class WorldRendererMixin {
    ...
    @Redirect(method = "renderBlockEntities", at = @At(value = "INVOKE", 
        target = "BlockEntityRenderDispatcher;render(...)"))
    private void redirectBlockEntityRender(BlockEntityRenderDispatcher dispatcher, 
                                          BlockEntity blockEntity, float tickProgress, 
