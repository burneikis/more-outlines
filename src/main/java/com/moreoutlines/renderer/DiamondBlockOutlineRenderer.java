...
public class DiamondBlockOutlineRenderer {
    
    public static void renderDiamondBlockOutlines(
        ...
        // Render each diamond block using the outline system
        for (BlockPos pos : blockPositions) {
            BlockState state = world.getBlockState(pos);
            if (!state.isAir() && (state.isOf(Blocks.DIAMOND_BLOCK))) {
